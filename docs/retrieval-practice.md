...
The catch most people get wrong: **re-reading feels more productive** because it's fluent and easy. But that fluency is an illusion ([see Self-Awareness](feedback-and-metacognition.md)). Testing feels harder precisely because it's doing more work.
...
!!! example "In poker"
    Drill **closed-book** in the GTO Wizard Trainer: decide your action and *why* **before** revealing the solver's answer. Reading solutions = review; predicting first = retrieval. → [Drilling Spots](poker/drilling.md)
...
---
*Sources: [Dunlosky et al. (2013)](https://www.aft.org/ae/fall2013/dunlosky) · [Roediger & Karpicke — the testing effect](https://journals.sagepub.com/doi/abs/10.1177/1529100612453266)*
